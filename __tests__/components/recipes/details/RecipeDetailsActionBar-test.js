...
describe("RatingComponent Test", () => {
    ...
    it('Favorite True', () => {
        ...
        expect(component.getByTestId('RatingCompontent').props.ownRating).toEqual(5)
        expect(component.getByTestId('RatingCompontent').props.avgRating).toEqual(3)
        expect(component.getByTestId('RatingCompontent').props.ratingCount).toEqual(17)
        expect(component.getByTestId('RatingCompontent').props.handleRating).toEqual(handleRating)
    ...
    it('Favorite false dark theme', () => {
        ...
        expect(component.getByTestId('Icon').props.name).toEqual("heart")
        expect(component.getByTestId('Icon').props.size).toEqual(35)
        expect(component.getByTestId('Icon').props.color).toEqual(Colors.lighter)
        expect(component.getByTestId('Icon').props.onPress).toEqual(handleFavorize)
    })
